...
# Popula o RDS automaticamente — o banco fica pronto assim que a EC2
# termina de subir, sem precisar de um passo manual separado (o RDS nao
# tem IP publico, entao isso so pode rodar daqui de dentro da VPC mesmo).
