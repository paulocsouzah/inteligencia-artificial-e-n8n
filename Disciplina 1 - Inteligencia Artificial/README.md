...
**Meu objetivo com esta disciplina** é fazer você sair sabendo utilizar
IA de forma prática em produtos, sistemas e processos — entendendo LLMs,
prompting, APIs, RAG, embeddings, agentes e as limitações de cada
abordagem.

Aqui eu vou te ensinar a **criar** capacidades inteligentes. Na disciplina
irmã, [n8n](<../Disciplina 2 - n8n/README.md>), eu te ensino a **conectar**
essas capacidades a processos e sistemas reais.
...
| 2 | Prompt Engineering | Online | Role, contexto, few-shot, decomposição de problemas, structured output | 🔜 Planejada |
...
LLMs      →  Prompt Engineering →  IA por API   →  RAG/Embeddings →  AI Agents →  Projeto Final
```

📂 [Começar pela Aula 01](<Aula 01 - Fundamentos de IA e LLMs/README.md>)
